function [IQ,Fc] = rf2iq(RF,Fs,Fc,B,analytic)
...
%
%   -- Damien Garcia -- 2012/01, last update: 2023/04
%   website: <a
%   href="matlab:web('https://www.biomecardio.com')">www.BiomeCardio.com</a>

%   AS = RF2IQ(RF,Fs,Fc,B,'analytic') returns the analytic signal. This is
%   a hidden syntax.
...
% hidden syntax
if nargin==5
    assert(isequal(lower(analytic),'analytic'),...
