...
%
%   BMODE(IQ,Gamma), with 0<Gamma<1, converts the I/Q signals (in IQ) to
%   8-bit log-compressed ultrasound images using a Gamma-compression.
%
%
%   Example:
%   -------
...
%
%   -- Damien Garcia -- 2020/06, last update: 2023-06-12
%   website: <a
...
assert(DR>0,'The dynamic range DR (in dB) or encoding gamma must be >0')
...
if DR>1
    ...
    I = (I/max(I,[],'all')).^DR;
    I = uint8(255*I); % 8-bit log-compressed image
end