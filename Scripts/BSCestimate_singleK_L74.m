...
for iImage = 1:8
    ...
    for depthSelect = 15:5:50 
        ...
        saveas(gcf,[saveDir_SEG,'\bscEstimationSegFigure_ENV.fig'])
        saveas(gcf,[saveDir_SEG,'\bscEstimationSegFigure_ENV.jpg'])
        ...
        saveas(gcf,[saveDir_SEG,'\bscEstimationWeightFigure.fig'])
        saveas(gcf,[saveDir_SEG,'\bscEstimationWeightFigure.jpg'])
