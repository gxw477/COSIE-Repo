function [] = bmCohCOSIEparImage_EML_video(xVals,yVals,bfImgData,depthIdx,axIdxs,powf0,segBool,rayIdxs,speckleCOSIE,cohTest,sumIdx,segIdx)
    ...
    ylim([5 max(speckleCOSIE.thVector)])
