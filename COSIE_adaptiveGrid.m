...
function [bscSurface,segSurface,EML,pctSeg1,redEML,pctSeg2] = COSIE_adaptiveGrid(cohValues,bscValues)
    ...
    [bscSurface,segSurface] = threshSurfaceGen_adaptive(cohValues,bscValues);
